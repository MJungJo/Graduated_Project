...
class TestView(TestCase):
    def setUp(self):
        ...
        self.user_obama.is_staff = True # 'obama'를 관리자로 인명
    ...
    def test_post_list(self):
        ...
        self.assertNotIn(self.tag_car.name, post_001_card.text)
        self.assertNotIn(self.tag_car_ko.name, post_001_card.text)
        ...
        self.assertNotIn(self.tag_car.name, post_002_card.text)
        self.assertNotIn(self.tag_car_ko.name, post_002_card.text)
        ...
        self.assertIn(self.tag_car.name, post_003_card.text)
        self.assertIn(self.tag_car_ko.name, post_003_card.text)
    ...
    def test_post_detail(self):
        ...
        self.assertIn(self.category_car.name, post_area.text)
        ...
        self.assertNotIn(self.tag_car.name, post_area.text)
        self.assertNotIn(self.tag_car_ko.name, post_area.text)
    ...
    def test_category_page(self):
        response = self.client.get(self.category_car.get_absolute_url())
        self.assertEqual(response.status_code, 200)
        ...
        self.assertIn(self.category_car.name, soup.h1.text)
    ...
    def test_comment_form(self):
        ...
        self.assertIn('오바마 댓글', new_comment_div.text)
